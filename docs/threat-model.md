...
Project-specific acceptance focus: Verify FIPS state on every node, scheduling constraints, prohibited algorithms/images, CIS results, node replacement, upgrade compatibility, performance impact, log evidence, and documented compliance limitations.
